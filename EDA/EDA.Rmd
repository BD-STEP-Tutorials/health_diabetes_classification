...
train <- as.tibble(predict(train_pre_obj, train_na_df))
test <- as.tibble(predict(train_pre_obj, test_na_df))
```
...
metric_targ <- 'Sens' # Spec, ROC, Prec, Sens
...
-   metric: a string that specifies what summary metric will be used to select the optimal model. By default, possible values are "RMSE" and "Rsquared" for regression and "Accuracy" for classification.
